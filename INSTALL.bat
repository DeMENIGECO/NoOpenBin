...
powershell -Command "Write-Host '- nim iv <versione>' -ForegroundColor Yellow"
echo    Installa una versione specifica
...
:iv
set "VERSION=%PROMPT:~7%"
set "INSTDIR=%LOCALAPPDATA%\NoOpenBin"
set "INSTURL=https://github.com/DeMENIGECO/NoOpenBin/raw/refs/heads/main/bin/nob_v%VERSION%_windows-64.zip"

echo.
echo Installazione NoOpenBin %VERSION% per questo utente...
